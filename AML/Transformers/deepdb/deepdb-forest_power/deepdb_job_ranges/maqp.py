...
from mumford_switch.code_generation.generate_code import generate_ensemble_code
...
if __name__ == '__main__':
    ...
    # fmetric = open('/home/zhangjintao/Benchmark3/metric_result/' + args.version + '.EINSTEINAI4DB.txt', 'a')
