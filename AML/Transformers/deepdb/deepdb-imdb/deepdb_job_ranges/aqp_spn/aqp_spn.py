...
from mumford_switch.algorithms.ranges import NominalRange, NumericRange
from mumford_switch.mumford_switch import mumford_switch
...
class AQPSPN(CombineSPN, mumford_switch):
    ...
    def __init__(self, meta_types, null_values, full_join_size, schema_graph, relationship_list, full_sample_size=None,
        ...
        mumford_switch.__init__(self, meta_types, null_values, full_sample_size,
                      column_names=column_names,
                      table_meta_data=table_meta_data)  # column_names来源是哪

    def add_dataset(self, dataset):
        """
        modifies the mumford_switch based on new dataset.
        What has to be done?
    ...
    def learn(self, train_data, rdc_threshold=0.3, min_instances_slice=1, max_sampling_threshold_cols=10000,
        ...
        mumford_switch.learn(self, train_data, rdc_threshold=rdc_threshold, min_instances_slice=min_instances_slice,
