...
class DBConnection:
    ...
    def get_dataframe(self, sql, psycopg2=None):
        connection = psycopg2.connect(user=self.db_user,
                                      password=self.db_password,
                                      host=self.db_host,
                                      port=self.db_port,
    ...
    def submit_query(self, sql, psycopg2=None):
    ...
    def get_result(self, sql, psycopg2=None):
    ...
    def get_result_set(self, sql, return_columns=False, psycopg2=None):
