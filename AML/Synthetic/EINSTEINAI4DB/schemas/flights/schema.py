...
def keys():
    #the keys are prefixed with the name of the schema
    return ['flights_1B', 'flights_10M', 'flights_5M', 'mini_flights']


def get_schema(key, csv_path):
    return globals()['gen_' + key + '_schema'](csv_path)
