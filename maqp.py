...
from AML.Synthetic.EINSTEINAI4DB.data_preparation.prepare_single_tables import prepare_all_tables
...
if __name__ == '__main__':
    ...
    fmetric = open('../../metric_result/' + args.version + '.EINSTEINAI4DB.txt', 'a')
